...
public:
    Icosahedron() {
        ...
        v0.position = {-1.0f,  phi, 0.0f}; v0.colour = {1.0f,1.0f,0.0f,1.0f};
        v1.position = { 1.0f,  phi, 0.0f}; v1.colour = {1.0f,1.0f,0.0f,1.0f};
        v2.position = {-1.0f, -phi, 0.0f}; v2.colour = {1.0f,1.0f,0.0f,1.0f};
        v3.position = { 1.0f, -phi, 0.0f}; v3.colour = {1.0f,1.0f,0.0f,1.0f};

        v4.position = {0.0f, -1.0f,  phi}; v4.colour = {1.0f,1.0f,0.0f,1.0f};
        v5.position = {0.0f,  1.0f,  phi}; v5.colour = {1.0f,1.0f,0.0f,1.0f};
        v6.position = {0.0f, -1.0f, -phi}; v6.colour = {1.0f,1.0f,0.0f,1.0f};
        v7.position = {0.0f,  1.0f, -phi}; v7.colour = {1.0f,1.0f,0.0f,1.0f};

        v8.position =  { phi, 0.0f, -1.0f};  v8.colour = {1.0f,1.0f,0.0f,1.0f};
        v9.position =  { phi, 0.0f,  1.0f};  v9.colour = {1.0f,1.0f,0.0f,1.0f};
        v10.position = {-phi, 0.0f, -1.0f}; v10.colour = {1.0f,1.0f,0.0f,1.0f};
        v11.position = {-phi, 0.0f,  1.0f}; v11.colour = {1.0f,1.0f,0.0f,1.0f};
    ...
    Icosahedron(int subdivision, glm::vec4 colour) {
